<?php
 /**
  * Title: 404 Page
  * Slug: data-science-specialist/404
  */
?>
...
<p class="has-text-align-center has-foreground-color has-text-color has-content-heading-font-size"><?php esc_html_e('Oops! That page cannot be found','data-science-specialist'); ?></p>
<!-- /wp:paragraph -->
